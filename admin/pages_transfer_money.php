...
if (isset($_POST['deposit'])) {
    ...
    if ($transaction_amt > $amt) {
        ...
        $query = "INSERT INTO iB_Transactions (tr_code, account_id, acc_name, account_number, acc_type,acc_amount',  tr_type, tr_status, client_id, client_name, client_national_id, transaction_amt, client_phone, receiving_acc_no, receiving_acc_name, receiving_acc_holder) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        //bind paramaters
        $rc = $stmt->bind_param('ssssssssssssssss', $tr_code, $account_id, $acc_name, $account_number, $acc_type,$acc_amount, $tr_type, $tr_status, $client_id, $client_name, $client_national_id, $transaction_amt, $client_phone, $receiving_acc_no, $receiving_acc_name, $receiving_acc_holder);
