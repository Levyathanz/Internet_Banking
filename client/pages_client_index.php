...
?>
  ...
  <body class="hold-transition login-page" style="background:url(../dist/bg.svg); background-size: cover;" >
    <div class="login-box">
    <div class="login-logo">
        <h3 style="background:white; text-transform: uppercase;" ><a href="../index.php"><?php echo $auth->sys_name; ?></h3></a>
      </div> 
      <!-- /.login-logo -->
      <div class="card">
