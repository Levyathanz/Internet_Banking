...
?>
    ...
    <body>
        ...
        <div style="display: inline-block;">
             <img src="dist/bg.svg" class="img-fluid img-cover" style="transform: scaleX(-1);-webkit-box-reflect: below;-webkit-box-reflect: below" />
        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto text-center">
                            ...
                            <br>
                            <a class="btn btn-success btn-lg mr-lg-2 my-1" href="client/pages_client_signup.php" role="button">Get started</a>
                        </div>
                    </div>
                </div>
            </div>
